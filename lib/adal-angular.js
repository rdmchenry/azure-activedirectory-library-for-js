...
(function () {
    ...
    if (angular) {
        ...
        AdalModule.provider('adalAuthenticationService', function () {
            ...
            this.$get = ['$rootScope', '$window', '$q', '$location', '$timeout', 'HttpAuthenticationBuffer', function ($rootScope, $window, $q, $location, $timeout, httpAuthenticationBuffer) {
...
<<<<<<< HEAD
                            if (!_adal._getItem(_adal.CONSTANTS.STORAGE.FAILED_RENEW)) {
                                ...
                                _adal.acquireToken(_adal.config.loginResource, function (error, tokenOut) {
                                    ...
                                    httpAuthenticationBuffer.flushRequestBuffer(error || !_oauthData.isAuthenticated);
                                });
                            }
=======
                            // Idtoken is expired or not present
...
<<<<<<< HEAD
                    acquiringIdToken: function () {
                        return _acquiringIdToken;
=======
